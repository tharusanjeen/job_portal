...
<body>
    ...
    <script>
        // Function to fetch stats from stats.php
        function fetchStats() {
            // Make a GET request to stats.php
            fetch('../../scripts/stats.php')
                .then(response => {
                ...
                .then(data => {
                    // Handle the fetched stats data here
                    console.log('Stats data:', data);

                    // Example: Updating the page with stats (you can customize this part)
                    document.getElementById('job_pending').textContent = data.jobs.pending;
                    document.getElementById('job_approved').textContent = data.jobs.approved;
                    document.getElementById('job_declined').textContent = data.jobs.rejected;

                    document.getElementById('application_pending').textContent = data.applications.pending;
                    document.getElementById('application_approved').textContent = data.applications.approved;
                    document.getElementById('application_rejected').textContent = data.applications.rejected;
                })
                .catch(error => {
        ...
        // Call the function to fetch stats when the page is loaded
