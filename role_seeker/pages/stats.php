                        ...
                        <div class="job_status_header">
                            <span>
                                ...
                                if (isset($_SESSION["user_id"])) {
                                    ...
                                    $pending = "SELECT * FROM applications WHERE user_id = ? and status = 'pending'";
                        ...
                        <div class="job_status_header">
                            <span>
                                ...
                                if (isset($_SESSION["user_id"])) {
                                    ...
                                    $pending = "SELECT * FROM applications WHERE user_id = ? and status = 'approved'";
                                    $stmt = $conn->prepare($pending);
                                    $stmt->bind_param("i", $user_id);
                                    $stmt->execute();
                                    $result = $stmt->get_result();
                        ...
                        <div class="job_status_header">
                            <span>
                                ...
                                if (isset($_SESSION["user_id"])) {
                                    ...
                                    $pending = "SELECT * FROM applications WHERE user_id = ? and status = 'declined'";
                                    $stmt = $conn->prepare($pending);
                                    $stmt->bind_param("i", $user_id);
                                    $stmt->execute();
                                    $result = $stmt->get_result();
